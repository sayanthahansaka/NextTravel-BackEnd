package com.sayantha.uplodeimageservice.advisor;


import com.sayantha.uplodeimageservice.response.Response;
...
public class GlobalExceptionHandler {
    ...
    public Response handleExceptions(Exception exception) {
        ...
        response.setMessage("Upload Server threw an exception : " + exception.getLocalizedMessage());
