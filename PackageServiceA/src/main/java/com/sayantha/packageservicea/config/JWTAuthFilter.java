package com.sayantha.packageservicea.config;
...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private com.sayantha.packageservicea.config.JWTService JWTService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (userName != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (JWTService.validateToken(jwtToken) && JWTService.getUserRole(jwtToken).equals("hotelAdmin") || JWTService.getUserRole(jwtToken).equals("vehicleAdmin") || JWTService.getUserRole(jwtToken).equals("p_Aadmin")) {
